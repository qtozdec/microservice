package com.microservices.user.audit;
...
public class AuditInterceptor implements HandlerInterceptor {
    ...
    private String getResourceTypeFromRequest(HttpServletRequest request) {
        ...
        if (uri.contains("/avatar")) return "AVATAR";
        if (uri.contains("/2fa")) return "TWO_FACTOR_AUTH";
    ...
    private String getResourceIdFromRequest(HttpServletRequest request) {
        ...
        // Extract ID from URI patterns like /users/123 or /users/123/profile
